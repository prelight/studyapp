...
if __name__ == '__main__':
    ...
    #つまり、MNISTが756のデータの集まりだったのが今回は25個のデータの集まり
    ...
    #データを1つ1つ1次元に1個にしている
    #訓練データは、1次元に1個、2次元が25個、三次元が不定(175個)
    x = tf.placeholder(tf.float32, shape=[None, maxlen, n_in])

    #訓練データのターゲットは、1次元に1個、2次元が不定(175個)
    ...
    for i in range(length_of_sequences - maxlen + 1):
        ...
        print("y_ :" + str(y_))
        #print(z_.reshape(maxlen, n_in)[1:])

        #print((z_.reshape(maxlen, n_in)[1:], y_))
