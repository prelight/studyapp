...
if __name__ == '__main__':
    ...
    print("X_train.shape(1) " + str(X_train.shape))
    print("X_test.shape " + str(X_test.shape))

    X_train, X_validation, Y_train, Y_validation = \
        train_test_split(X_train, Y_train, test_size=N_validation)

    print("X_train.shape(2) " + str(X_train.shape))
    print("X_validation.shape " + str(X_validation.shape))

    #------ oka 
    print("len(mnist.data) " + str(len(mnist.data)))
    print("X_validation.shape " + str(X_validation.shape))
    ...
    for epoch in range(epochs):
        ...
        for i in range(n_batches):
            ...
            #Xは784のデータが200(=batch_size)づつ
            #Yは10のデータが200(=batch_size)づつ
    ...
    #plt.savefig('mnist_tensorflow.png')
