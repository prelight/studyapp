...
def make_dataset2(max_photo, outfile, rotate):
  ...
  y = []
  # 各画像のフォルダを読む
  glob_images2("201712_week2/sakura-ok", 0, max_photo, rotate)
  glob_images2("201712_week2/sunflower-ok", 1, max_photo, rotate)
  glob_images2("201712_week2/rose-ok", 2, max_photo, rotate) 
  X = np.array(X, dtype=np.float32)
  np.savez(outfile, X=X, y=y)
  print("saved:" + outfile)

# データセットを作成する
make_dataset2(100, "201712_week2/photo-min2.npz", rotate=True)
make_dataset2(100, "201712_week2/photo-test.npz", rotate=False)
